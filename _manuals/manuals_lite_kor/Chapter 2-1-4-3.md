---
layout: post
title: 2.1.4.3.	Chip Image Setting
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10;">
  ...
  <!-- 다음 페이지 버튼 -->
  <a href="/manuals/manuals_lite_kor/Chapter 2-1-5/" class="btn btn-primary" style="display: inline-block; padding: 5px 10px; background-color: #6c757d; color: white; text-decoration: none; border-radius: 5px;">
    Next →
  </a>
</div>