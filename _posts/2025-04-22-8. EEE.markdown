---
layout: post
title: Space Product Assurance(우주 제품 품질 보증)란?
...
- ECSS(European Cooperation for Space Standardization): ESA(유럽우주국), 유럽 각국 우주 기관 및 산업체들이 공동으로 개발하여,
...
- EEE-INST-002: NASA의 EEE 부품 관리 및 활용 지침
