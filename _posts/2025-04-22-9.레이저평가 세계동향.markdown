...
<p align="center"> 
  <img src="/assets/Articles/COTS NSSC.png" style="width: 80%; max-width: 450px;">
</p>
...
<table align="center" style="border: none; border-collapse: collapse; width: 100%;">
  <tr>
    <td align="center" style="border: none; width: 50%;">
      <img src="/assets/Articles/NRNU MEPhI SPELS.png" style="height: auto; max-height: 350px; width: 100%; max-width: 450px;">
      <div style="margin-top: 10px;">Actual rate of conducted test in NRNU(2015)</div>
    </td>
    <td align="center" style="border: none; width: 50%;">
      <img src="/assets/Articles/NRNU MEPhI SPELS 2.png" style="height: auto; max-height: 350px; width: 100%; max-width: 450px;">
