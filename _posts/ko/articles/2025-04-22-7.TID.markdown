...
rad는 radiation absorbed dose의 약자로 물질의 단위 질량당 흡수한 에너지의 크기를 나타내는 흡수선량 단위입니다. D = dε/dm으로 정의되며 여기서 dε는 물질이 흡수한 에너지, dm은 그 질량입니다. 1 rad는 1그램이 100 erg의 에너지를 흡수한 경우에 해당하고 SI 단위로 환산하면 0.01 J/kg 이고 같은 방식으로 정의 되는 Gy(그레이)가 있고, 100 rad는 1 Gy 입니다.
